...
public class SpentbudgetFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        context=getActivity();
        return inflater.inflate(R.layout.fragment_spentbudget, container, false);
    }
    ...
    public void onStart() {
        ...
        fab= context.findViewById(R.id.add_new_expense);
        mAuth=FirebaseAuth.getInstance();
        budgetReference= FirebaseDatabase.getInstance().getReference("Users").child(mAuth.getCurrentUser().getUid()).child("Events").child(key).child("SpentBudget");
        loader=new ProgressDialog(getActivity());

        total_amount=context.findViewById(R.id.total_budget);
        budgetRecycle=context.findViewById(R.id.Spent_budget_recycle);
